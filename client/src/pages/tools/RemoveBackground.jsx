...
import { removeBackground, downloadImage } from '../../services/clipdrop';
...
const RemoveBackground = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Remove Background</h1>
      ...
      {result && (
        <div className="bg-white shadow-md rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Image with Background Removed</h2>
          <div className="aspect-square max-w-md mx-auto mb-4 bg-gray-100 rounded-md overflow-hidden">
