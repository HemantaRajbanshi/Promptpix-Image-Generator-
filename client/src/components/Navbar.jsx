            ...
            {isAuthenticated ? (
              <>
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Link
                    to="/dashboard"
                    className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-700 rounded-full transition-all duration-medium"
                  >
                    Dashboard
                  </Link>
                </motion.div>
              ...
              <>
                ...
                >
                  <Link
                    to="/signup"
                    className="inline-flex items-center px-6 py-2.5 text-sm font-medium rounded-full text-white bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 shadow-lg hover:shadow-xl transition-all duration-medium"
                  >
                    Sign up
                  </Link>
                </motion.div>
            ...
            <div className="px-4 pt-4 pb-6 space-y-2 bg-white/98 dark:bg-black/98 backdrop-blur-xl border-t border-gray-200/20 dark:border-gray-700/20">
              ...
              {isAuthenticated ? (
                ...
                >
                  <Link
                    to="/login"
                    className="block px-4 py-3 rounded-2xl text-base font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-medium"
                    onClick={closeMenu}
                  >
                    Log in
                  </Link>
                  <Link
                    to="/signup"
                    className="block w-full text-center px-6 py-3 text-base font-medium rounded-2xl text-white bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 shadow-lg transition-all duration-medium"
                    onClick={closeMenu}
                  >
                    Sign up
                  </Link>
